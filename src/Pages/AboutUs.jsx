    ...
    <img src="/your-decorative-circle.png" alt="bg" />
      ...
      <section className="bg-white py-16 px-6 md:px-24 text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
          {[
            { name: "Ram Shastri", role: "Designer", img: "https://media.istockphoto.com/id/1319014901/photo/receptionist-in-a-hotel-lobby-holding-a-clipboard.jpg?s=612x612&w=0&k=20&c=xVcZukZvsYS9USlsY1_TFTmpkmDZ1ZG2uoOD0zRJBbY=" },
            { name: "Disha", role: "Manager", img: "https://html.themewant.com/moonlit/assets/images/pages/team/2.webp" },
            { name: "Dipika singh", role: "Chef", img: "https://st2.depositphotos.com/1029150/9319/i/950/depositphotos_93194186-stock-photo-indian-woman-in-chef-uniform.jpg" },
            { name: "Divya ", role: "Receptionist", img: "https://t3.ftcdn.net/jpg/08/14/79/50/360_F_814795016_ri4j9MDAgOzgxvE0X8iERe7a6WWsWIVe.jpg" },
          ].map((member, index) => (
            <div key={index}>
              <img
                src={member.img}
                alt={member.name}
                className=" mx-auto w-72 h-76 object-cover mb-4"
              />
              <h3 className="text-lg font-semibold">{member.name}</h3>
              <p className="text-sm text-gray-500">{member.role}</p>
              <div className="flex gap-4 mt-5 ml-17">
      {/* Facebook */}
      <a
        href="https://facebook.com"
        target="_blank"
        rel="noopener noreferrer"
        className="w-10 h-10  flex items-center justify-center rounded-full bg-gray-600 hover:bg-blue-600 transition"
      >
        <svg
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-600 hover:bg-blue-800 transition"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="white"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-600 hover:bg-green-600 transition"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="white"
